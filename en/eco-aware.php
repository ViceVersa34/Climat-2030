...
<body id="body">
    ...
    <main>
        <h1 class="top_txt"><?php echo html_entity_decode($contenuView['eco-sensibilise']['en']['titre 1']['contenu']) . ' <span class="orange-txt size-txt2 font-family">' . $customers[0]['compteur'] . '</span> ' . html_entity_decode($contenuView['eco-sensibilise']['en']['titre 2']['contenu']); ?></h1>
        
        <div class="titre-eco-sensibilise"><?php echo html_entity_decode($contenuView['eco-sensibilise']['en']['contenu']['contenu']); ?></div>
