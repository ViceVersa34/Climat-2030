...
<div class="contents">
    <div class="group-content">
        <div class="language">
            <?php
                    ...
                    $tempContenu = $contenu['CGU']['fr']['titre partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['fr']['titre partie legale']['contenu'];
                    $tempId = $contenu['CGU']['fr']['titre partie legale']['id'];
                    $language = 'fr';
                ?>
        ...
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['en']['titre partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['en']['titre partie legale']['contenu'];
                    $tempId = $contenu['CGU']['en']['titre partie legale']['id'];
                    $language = 'en';
                ?>
            <?php include('repeat.php'); ?>
        </div>
    ...
    <div class="group-content">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['fr']['partie 1 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['fr']['partie 1 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['fr']['partie 1 partie legale']['id'];
                    $language = 'fr';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['fr']['partie 2 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['fr']['partie 2 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['fr']['partie 2 partie legale']['id'];
                    $language = 'fr';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['fr']['partie 3 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['fr']['partie 3 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['fr']['partie 3 partie legale']['id'];
                    $language = 'fr';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['fr']['partie 4 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['fr']['partie 4 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['fr']['partie 4 partie legale']['id'];
                    $language = 'fr';
                ?>
            <?php include('repeat.php'); ?>
        </div>
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['en']['partie 1 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['en']['partie 1 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['en']['partie 1 partie legale']['id'];
                    $language = 'en';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['en']['partie 2 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['en']['partie 2 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['en']['partie 2 partie legale']['id'];
                    $language = 'en';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['en']['partie 3 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['en']['partie 3 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['en']['partie 3 partie legale']['id'];
                    $language = 'en';
                ?>
            <?php include('repeat.php'); ?>
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
                    $tempContenu = $contenu['CGU']['en']['partie 4 partie legale']['contenu'];
                    $tempContenuView = $contenuView['CGU']['en']['partie 4 partie legale']['contenu'];
                    $tempId = $contenu['CGU']['en']['partie 4 partie legale']['id'];
                    $language = 'en';
                ?>
            <?php include('repeat.php'); ?>
        </div>
...
<div class="group-content">
    <div class="content">
        <img src="<?php echo $images['club-pedagogique']['illustration 1']['image']; ?>" class="image-credit"
            alt="Crédit image 2">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
...
<div class="group-content">
    <div class="content">
        <img src="<?php echo $images['club-climat']['illustration 1']['image']; ?>" class="image-credit"
            alt="Crédit image 3">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
...
<div class="group-content">
    <div class="content">
        <img src="<?php echo $images['club-climat']['illustration 2']['image']; ?>" class="image-credit"
            alt="Crédit image 4">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
...
<div class="group-content">
    <div class="content">
        <img src="<?php echo $images['club-humour']['illustration 1']['image']; ?>" class="image-credit"
            alt="Crédit image 5">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
...
<div class="group-content">
    <div class="content">
        <img src="<?php echo $images['footer']['illustration 1']['image']; ?>" class="image-credit"
            alt="Crédit image 6">
        <div class="language">
            <?php
                    // Récupère le contenu, la vue du contenu et l'ID du titre en français à partir des variables $contenu et $contenuView
