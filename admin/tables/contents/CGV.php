<?php
    ...
    array_key_exists('contents_content', $_GET)) {
        ...
        // Redirige l'utilisateur vers la page "/admin/tables/contents/CGV.php#r$id_contents"
        header("Refresh: 0;url=/admin/tables/contents/CGV.php#r$id_contents");
    }
