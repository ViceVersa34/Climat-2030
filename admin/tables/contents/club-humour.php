<?php
    ...
    array_key_exists('contents_content', $_GET)) {
        ...
        // Redirige l'utilisateur vers la page "/admin/tables/contents/club-humour.php#r$id_contents"
        header("Refresh: 0;url=/admin/tables/contents/club-humour.php#r$id_contents");
    }
    ...
    <main>
        ...
        <div class="pages">
            <div class="page index">
                <?php include('part/club-humour.php'); ?>
