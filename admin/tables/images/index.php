        ...
        if($_POST['action'] == 'updateImage') { 
            ...
            if ($_FILES['image']['error'] === UPLOAD_ERR_OK) {
                ...
                if (move_uploaded_file($tempFile, $targetFile)) {
                    ...
                    header("Refresh: 0;url=/admin/tables/images/index.php");
                } else {
            ...
            <div class="page index">
                <div class="images">
                    <div class="group-image">
                        <div class="image">
                            <img src="<?php echo $images['index']['illustration 1']['image']; ?>">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="action" value="updateImage">
                                <input type="hidden" name="id_images" value="<?php echo $images['index']['illustration 1']['id']; ?>">
                                <input type="hidden" name="oldImage" value="<?php echo $images['index']['illustration 1']['image']; ?>">
